...
const querys ={
        getAll:'select * from prGetcvlanguage(null)',
        getById:'select * from prGetcvlanguage($1)',
        add:'select prPostcvlanguage($1)',
        update:'select prPutcvlanguage($1, $2, $3)',
        remove:'select prDeletecvlanguage($1)',
