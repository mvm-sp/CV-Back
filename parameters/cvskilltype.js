...
const querys ={
        getAll:'select * from prGetcvskilltype(null)',
        getById:'select * from prGetcvskilltype($1)',
        add:'select prPostcvskilltype($1)',
        update:'select prPutcvskilltype($1, $2, $3)',
        remove:'select prDeletecvskilltype($1)',
